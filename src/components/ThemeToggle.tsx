    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" size="sm">
          ...
          <Icons.Palmtree className="absolute rotate-90 scale-0 transition-all hover:text-slate-900 vacay:text-lime-200 dark:rotate-0 dark:scale-0 dark:text-slate-400 dark:hover:text-slate-100" />
      ...
      <DropdownMenuContent align="end" forceMount>
        ...
        <DropdownMenuItem onClick={() => setTheme("vacay")} disabled>
          <Icons.Palmtree className="mr-2 h-4 w-4" />
          <span>Vacation</span>
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
